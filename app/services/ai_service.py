...
class GeminiService:
    ...
    def get_assigment(self, prompt: str):
        try:
            ...
            raise RuntimeError("Invalid response from Gemini model.", e)
    ...
    def _setup_gemini(self):
        ...
        try:
            ...
            if response_message == "I am ready to help":
                ...
                raise RuntimeError("Gemini setup failed. Please check the prompt file.")
        except JSONDecodeError:
            print("Gemini setup failed. Expected json serializable response, but got:", response.text)
            raise RuntimeError("Gemini setup failed. Got non-json serializable response. Please check the prompt file.")
